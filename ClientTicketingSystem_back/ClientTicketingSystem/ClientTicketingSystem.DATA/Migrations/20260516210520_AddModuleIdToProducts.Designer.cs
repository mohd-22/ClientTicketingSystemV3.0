...
namespace ClientTicketingSystem.DATA.Migrations
{
    ...
    [Migration("20260516210520_AddModuleIdToProducts")]
    partial class AddModuleIdToProducts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClientTicketingSystem.CORE.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2026, 5, 17, 0, 5, 19, 853, DateTimeKind.Local).AddTicks(5256),
