...
namespace ClientTicketingSystem.DATA.Migrations
{
    ...
    [Migration("20260519155737_deleteProductsModulesTable")]
    partial class deleteProductsModulesTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClientTicketingSystem.CORE.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2026, 5, 19, 18, 57, 36, 489, DateTimeKind.Local).AddTicks(4031),
