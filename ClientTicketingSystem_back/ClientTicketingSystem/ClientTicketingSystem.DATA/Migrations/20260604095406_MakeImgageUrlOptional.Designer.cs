...
namespace ClientTicketingSystem.DATA.Migrations
{
    ...
    [Migration("20260604095406_MakeImgageUrlOptional")]
    partial class MakeImgageUrlOptional
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClientTicketingSystem.CORE.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2026, 6, 4, 12, 54, 5, 658, DateTimeKind.Local).AddTicks(878),
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2026, 6, 4, 12, 54, 5, 658, DateTimeKind.Local).AddTicks(883),
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2026, 6, 4, 12, 54, 5, 658, DateTimeKind.Local).AddTicks(887),
            ...
            modelBuilder.Entity("ClientTicketingSystem.CORE.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2026, 6, 4, 12, 54, 5, 658, DateTimeKind.Local).AddTicks(637),
