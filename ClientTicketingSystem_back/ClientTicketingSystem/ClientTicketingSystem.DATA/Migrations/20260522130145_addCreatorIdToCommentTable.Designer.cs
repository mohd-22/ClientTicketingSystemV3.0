...
namespace ClientTicketingSystem.DATA.Migrations
{
    ...
    [Migration("20260522130145_addCreatorIdToCommentTable")]
    partial class addCreatorIdToCommentTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClientTicketingSystem.CORE.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2026, 5, 22, 16, 1, 44, 336, DateTimeKind.Local).AddTicks(3019),
