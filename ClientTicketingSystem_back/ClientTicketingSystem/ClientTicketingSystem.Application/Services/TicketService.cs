...
public class TicketService : ITicketService
{
    ...
    public TicketService(IUnitOfWork unitOfWork, ILogger<ProductModuleService> logger)
    {
    ...
    public async Task<ApiResponse<CreateTicketDto>> CreateTicket(CreateTicketDto TicketDto)
    {
        var ticket = new Ticket
        {
            ...
            ProductMoudleId = TicketDto.ProductModuleId,
        };
    ...
    public async Task<ApiResponse<bool>> UpdateTicket(CreateTicketDto dto, Guid TicketId)
    {
        ...
        request.ProductMoudleId = dto.ProductModuleId;
    ...
    public async Task<ApiResponse<PaginationDto<TicketDto>>> GetAllTickets(string? search, string? sort, TicketStatus? status, int pageIndex, int pageSize,UserRole role, Guid userId)
    {
        try
        {
            ...
            var ticketDtos = tickets.Select(ticket => new TicketDto
            {
                ...
                ProductModuleName = ticket.ProductModule?.Name ?? string.Empty,
